...
CONTAINS
    ...
    SUBROUTINE force_cell_list_2D(Rx, Ry, Fx, Fy, pot_en)
        ...
        REAL, DIMENSION(:), ALLOCATABLE :: cell_Rxl, cell_Ryl, cell_Fxl, cell_Fyl
        REAL, DIMENSION(:), ALLOCATABLE :: cell_Rxs, cell_Rys, cell_Fxs, cell_Fys
    ...
    ELEMENTAL INTEGER FUNCTION cell_id(c, b, a)
    ...
    ELEMENTAL INTEGER FUNCTION cell_id_2D(b, a)
